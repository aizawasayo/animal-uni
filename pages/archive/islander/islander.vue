<template>
  <toolbar-paging-list apiType="islander" :listApi="listApi" :pageSize="12">
        ...
        <view class="item-info">
          ...
          <view class="info-left">
            <view class="info-name">
              ...
              <text
                class="islander-sex"
                :style="{ color: item.sex === 0 ? '#ffc0cb' : '#80DEEA' }"
                >{{ item.sex === 0 ? '♀' : '♂' }}</text
              >
            </view>
            <text class="islander-motto"
              >{{ item.character }} - {{ item.motto }}</text
            >
          </view>
