  ...
  >
    <view class="content-box">
      <view class="content-header">
        <uni-tag
          v-if="item.exchangeType === '我有菜'"
          text="我有菜"
          size="small"
          custom-style="background-color: #3FB984; color: #fff; border-color: #3FB984;"
        ></uni-tag>
        <uni-tag
          v-else
          text="我有价"
...
import { addTurnip, getTurnip } from '@/request_api/turnip'
...
export default {
  ...
  setup(props, { emit }) {
    ...
    const { isLiked, addLike } = useLike(item, addTurnip, () =>
      props.refreshItem(getTurnip, item.value._id)
    )
