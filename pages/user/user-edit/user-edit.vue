    ...
    <view class="formContainer">
      ...
      >
        ...
        <uni-forms-item
          label="岛屿名称"
          name="islandName"
          leftIcon="paperplane-filled"
          icon-color="#3f51b5"
        >
          <uni-easyinput
            v-model="userFormData.islandName"
            placeholder="岛屿名称"
            :inputBorder="false"
            @input="isValid = true"
            style="font-size: 16px"
        ...
        >
          <uni-easyinput
            type="textarea"
            v-model="userFormData.signature"
            placeholder="请输入个性签名"
            @input="isValid = true"
          />
        </uni-forms-item>
