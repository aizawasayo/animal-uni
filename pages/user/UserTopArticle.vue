<template>
  <view class="userTopArticle">
    <view class="userArticle" @click="utils.goPage('/pages/user/user-post/user-post')">
    ...
    <view class="userArticle" @click="utils.goPage('/pages/user/user-design/user-design')">
...
<script>
  ...
  export default {
    ...
    setup(props) {
      ...
      const postNum = computed(() => boardNum.value + turnipNum.value + tradeNum.value)
