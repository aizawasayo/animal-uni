<template>
  <view class="loading-popup">
    <view class="shade-popup" :class="[ani]"></view>
    <view class="loading-content" :class="[ani]"
...
<style lang="scss">
  ...
  .circle-loading {
    ...
    .dot {
      ...
      width: 150rpx;
      height: 150rpx;
      animation: 1.5s loadrotate cubic-bezier(0.800, 0.005, 0.300, 1.000) infinite;
      ...
      .first-dot {
        background: #3FB984;
        animation: 1.5s dotscale cubic-bezier(0.800, 0.005, 0.300, 1.000) infinite;
